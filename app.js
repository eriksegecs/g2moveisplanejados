    ...
    layoutGridEl.innerHTML = result.layouts
      .map((layout, panelIndex) => {
        ...
        return [
          ...
          `<line x1="0" y1="0" x2="112" y2="112" stroke="#4a4a4a" stroke-opacity="0.65" stroke-width="1.6"></line>`,
          `<line x1="112" y1="0" x2="0" y2="112" stroke="#4a4a4a" stroke-opacity="0.35" stroke-width="1.1"></line>`,
          `</pattern>`,
          `</defs>`,
