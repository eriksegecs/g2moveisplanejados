    ...
    layoutGridEl.innerHTML = result.layouts
      .map((layout, panelIndex) => {
        ...
        return [
          ...
          `</pattern>`,
          `<pattern id="${hatchId}" patternUnits="userSpaceOnUse" width="28" height="28">`,
          `<rect x="0" y="0" width="28" height="28" fill="transparent"></rect>`,
          `<line x1="0" y1="0" x2="28" y2="28" stroke="#4a4a4a" stroke-opacity="0.65" stroke-width="1.6"></line>`,
          `<line x1="28" y1="0" x2="0" y2="28" stroke="#4a4a4a" stroke-opacity="0.35" stroke-width="1.1"></line>`,
          `</pattern>`,
          `</defs>`,
