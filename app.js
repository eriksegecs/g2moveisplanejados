    ...
    layoutGridEl.innerHTML = result.layouts
      .map((layout, panelIndex) => {
        ...
        return [
          ...
          `<line x1="0" y1="0" x2="10" y2="10" stroke="#4a4a4a" stroke-opacity="0.7" stroke-width="1.6"></line>`,
          `<line x1="10" y1="0" x2="0" y2="10" stroke="#4a4a4a" stroke-opacity="0.45" stroke-width="1.2"></line>`,
          `</pattern>`,
          `</defs>`,
